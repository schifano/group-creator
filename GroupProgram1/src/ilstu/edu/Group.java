...
public class Group {
	...
	/**
	 *   This method will call the Student method to see if the passed in Student matches
	 *   any of the students already contained in the arrayList contained in this Group. 
	 *   @return boolean indicator which is true if the student exists in the Group
	 */
